...
function setup() {
    ...
    html.items.addToCartButtonWhoppersMaltedMilkBallsImage = document.getElementById("addToCartButtonWhoppersMaltedMilkBallsImage");
    html.items.nutellaImage = document.getElementById("nutellaImage");
    html.items.addToCartButtonNutellaImage = document.getElementById("addToCartButtonNutellaImage");
    html.items.boxedWaterImage = document.getElementById("boxedWaterImage");
    html.items.addToCartButtonBoxedWaterImage = document.getElementById("addToCartButtonBoxedWaterImage");
    html.items.pringlesImage = document.getElementById("pringlesImage");
    html.items.addToCartButtonPringlesImage = document.getElementById("addToCartButtonPringlesImage");
    html.items.kitkatImage = document.getElementById("kitkatImage");
    html.items.addToCartButtonKitkatImage = document.getElementById("addToCartButtonKitkatImage");
    html.items.pepperidgeFarmCookiesImage = document.getElementById("pepperidgeFarmCookiesImage");
    html.items.addToCartButtonPepperidgeFarmCookiesImage = document.getElementById("addToCartButtonPepperidgeFarmCookiesImage");
    html.items.pockyImage = document.getElementById("pockyImage");
    html.items.addToCartButtonPockyImage = document.getElementById("addToCartButtonPockyImage");
    html.items.skinnyPopPopcornImage = document.getElementById("skinnyPopPopcornImage");
    html.items.addToCartButtonSkinnyPopPopcornImage = document.getElementById("addToCartButtonSkinnyPopPopcornImage");
    ...
    html.items.addToCartButtonWhoppersMaltedMilkBallsImage.addEventListener("click", selectItem.bind(null, "whoppersMaltedMilkBalls"));
    html.items.nutellaImage.addEventListener("click", selectItem.bind(null, "nutella"));
    html.items.addToCartButtonNutellaImage.addEventListener("click", selectItem.bind(null, "nutella"));
    html.items.boxedWaterImage.addEventListener("click", selectItem.bind(null, "boxedWater"));
    html.items.addToCartButtonBoxedWaterImage.addEventListener("click", selectItem.bind(null, "boxedWater"));
    html.items.kitkatImage.addEventListener("click", selectItem.bind(null, "kitkat"));
    html.items.addToCartButtonKitkatImage.addEventListener("click", selectItem.bind(null, "kitkat"));
    html.items.pringlesImage.addEventListener("click", selectItem.bind(null, "pringles"));
    html.items.addToCartButtonPringlesImage.addEventListener("click", selectItem.bind(null, "pringles"));
    html.items.pepperidgeFarmCookiesImage.addEventListener("click", selectItem.bind(null, "pepperidgeFarmCookies"));
    html.items.addToCartButtonPepperidgeFarmCookiesImage.addEventListener("click", selectItem.bind(null, "pepperidgeFarmCookies"));
    html.items.pockyImage.addEventListener("click", selectItem.bind(null, "pocky"));
    html.items.addToCartButtonPockyImage.addEventListener("click", selectItem.bind(null, "pocky"));
    html.items.skinnyPopPopcornImage.addEventListener("click", selectItem.bind(null, "skinnyPopPopcorn"));
    html.items.addToCartButtonSkinnyPopPopcornImage.addEventListener("click", selectItem.bind(null, "skinnyPopPopcorn"));
